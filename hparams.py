...
hparams = tf.contrib.training.HParams(
    ...
    n_fft = 2048, #Extra window size is filled with 0 paddings to match this parameter
	hop_size = 160, #For 16000Hz, 275 ~= 12.5 ms (0.0125 * sample_rate)
	win_size = 640, #For 16000Hz, 640 ~= 40 ms (If None, win_size = n_fft) (0.05 * sample_rate)
	sample_rate = 16000, #22050 Hz (corresponding to ljspeech dataset) (sox --i <filename>)
	frame_shift_ms = None, #Can replace hop_size parameter. (Recommended: 12.5)
	magnitude_power = 2., #The power of the spectrogram magnitude (1. for energy, 2. for power)
	...
	tacotron_adam_beta1 = 0.95, #AdamOptimizer beta1 parameter
